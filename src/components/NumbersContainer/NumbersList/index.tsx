                    ...
                    <StyledCompostDiv>
                        {
                            ...
                            <>
                                ...
                                <ul className='compost-list x-list'>
                                    <ClearAll action={() => dispatch(removeAllNumbers('x'))} />
                                    {
                                        xNumbers.map((num) =>
                                            <NumberItem
                                                num={num.num}
                                                key={num.id}
                                                action={() => dispatch(removeXNumber(num.id))}
                                                id={num.id}
                                                array='x'
                                            />
                                        )
                        ...
                        }        
                        {
                            ...
                            <>
                                ...
                                <ul className='compost-list y-list'>
                                    <ClearAll action={() => dispatch(removeAllNumbers('y'))} />
                                    
                                    {
                                        yNumbers.map((num) =>
                                            <NumberItem
                                                num={num.num}
                                                key={num.id}
                                                action={() => dispatch(removeYNumber(num.id))}
                                                id={num.id}
                                                array='y'
                                            />
                                        )
                        ...
                        <div className="unique__clear-all">
                            {
                                uniqueNumbers.length >= 1 &&
                                    <ClearAll action={() => dispatch(removeAllNumbers('unique'))} />
                            }
                        </div>
                                    ...
                                    <ul className='unique-list list'>
                                        {
                                            uniqueNumbers.map((num) =>
                                                <NumberItem
                                                    num={num.num}
                                                    key={num.id}
                                                    action={() => dispatch(removeUniqueNumber(num.id))}
                                                    id={num.id}
                                                    array='unique'
                                                />
                                            )
